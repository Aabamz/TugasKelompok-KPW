    ...
    <div class="col-md-4">
        <div class="card card-primary card-outline bg-dark text-center">
            <div class="card-body box-profile">
                <img class="profile-user-img img-fluid img-circle mb-3" src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : 'https://i.pravatar.cc/150?u=' . $user->id); ?>" alt="User profile picture">
